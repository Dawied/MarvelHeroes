...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\School\laravel\MarvelHeroes\starter\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\School\\laravel\\MarvelHeroes\\starter\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'heroes.index','heroes.create','heroes.store',
'heroes.show','heroes.edit','heroes.update','heroes.destroy','abilities.index',
'abilities.create','abilities.store','abilities.show','abilities.edit','abilities.update',
'abilities.destroy','storage.local',);
        registerArgumentsSet('views', 
'abilities.create','abilities.edit','abilities.index','heroes.create','heroes.edit',
'heroes.index','home','layouts.app','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
